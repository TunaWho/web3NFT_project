...
contract RoboPunksNFT is ERC721, Ownable {
    ...
    function mint(uint256 _quantity) public payable {
        ...
        require(totalSupplyMinted._value.add(_quantity) <= maxSupply, "sold out");
        require(totalMintedPerWallet[msg.sender].add(_quantity) <= maxPerWallet, "wallet reached max minting able");
